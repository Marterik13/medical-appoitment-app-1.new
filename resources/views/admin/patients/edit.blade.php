    ...
    <div class="border-b border-gray-200">
        ...
        {{-- Tab 1: de datos personales --}}
            <li class="me-2">
                ...
                class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg group transition-colors duration-200"
    ...
    <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded-r-lg shadow-sm">
        <div class="flex items-start">
            ...
            <div class="flex-shrink-0">
                ...
                href="{{ route('admin.users.edit', $patient->user) }}" target="_blank">
                    Editar usuario
